...
@section('title', 'Provider Feedback')
@section('header')
...
<div class="feedback">
	<div class="container feedcontain">
		<div class="panel panel-default">
             ...
             <form name="provider_feedback" method="post" action="{{URL('/')}}/providerfeedback">
		...
		<div class="contpad">
		<div>
			<h4 class="likely">Feedback to Freelancer</h4>
		...
		<div class="row">
              ...
              <span class="bill-p"><a href="{{URL('/providerofferview/'.$id.'/'.$jobid)}}" class="bill-a-size empbut">Cancel</a></span>
         </div>
		<!-- <button class="clear profsetbut">Submit Feedback</button>
  	 ...
  	 $( document ).ready(function() {
         ...
         total = 0;
  	 	    ...
  	 	    if(cals > 0.50){
  	 	    	...
  	 	    	ans2 = ans1 % 1;
  	 	    	answer= ans1 - ans2;
  	 	    	answer = parseFloat(answer) + parseFloat(1);
  	 	    	answer = answer.toFixed(1);
  	 	    	$('#totalscore').html(answer);
  	 	    	$('.totalscore').val(answer);
   	 	    }
