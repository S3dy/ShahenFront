...
<div class="container pagepad ">
  ...
  ?>
    ...
    <div class="col-md-12">
        ...
        <form id="add_account_details" name="freelancer_add_account" action="AddAccountDetails" enctype="multipart/form-data" method="post">
        ...
        <div class="card card-block m-0 contact-cust-card myjob_b_80">
            <div class="row">
              <span class="offer-m-15">
                  <input type="submit" id="add_card" class="cust-btn-primary btn text-capitalize m-0 retpass post-end add_card" value="Add Account">
              </span>
