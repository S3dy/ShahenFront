...
<div id="main">
    ...
    <section class="content-inner section-bg ">
        <div class="pagepad">
          ...
          @if(session('flag') ==1)
              <div class="alert alert-danger " id="alert_successbydynamic">
                This Footer is already Exists...
              </div>
            @endif
        <div class="panel panel-default" style="margin-bottom:150px">
        <!-- Default panel contents -->
        <form id="add_footer" action="{{URL('/')}}/admin/addfooter" method="post"> 
        ...
        <div class="panel-body">
          <div class="row">
            <input type="hidden" name="footchange" value="HOME">
           <label  class="col-md-12 control-label">Footersection</label>
            ...
            <div class="col-md-12 foot_b">
              <div><input type="text" name="footname" id="add_foot" placeholder="Footer Name" class="foot_text"></div><span class="hider login-error error-color" id="foot_error"><i class="fa fa-exclamation-circle error-icon" aria-hidden="true"></i>This field is required.</span>    
            </div>
            
            <label  class="col-md-12 control-label">Title of the page</label>
            <div class="col-md-12 foot_b">
              <div><input type="text" name="pagetitle" id="page_tittle" placeholder="Page Tittle" class="foot_text"></div>
            ...
            <div class="col-md-12 foot_b">
              <div><input type="text" name="footurl" id="foot_url" placeholder="Hyper Link" class="foot_text"></div>
            ...
            <div class="col-md-12 foot_b">
              <div><textarea rows="5" class="foottextarea" name="foottextarea" id="foot_textarea" placeholder="Description"></textarea></div>    
